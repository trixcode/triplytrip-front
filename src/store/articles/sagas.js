...
export function* watchGetArticlesToFooterRequest() {
  while (true) {
    const { articlePage } = yield take(actionTypes.GET_ARTICLES_TO_FOOTER_START);
    yield call(getArticlesToFooterRequest, articlePage);
  }
}
